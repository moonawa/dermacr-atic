...
<body class="hold-transition sidebar-mini" style="background: white">
    <div id="app">
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: white">
               ...
               <li class="nav-item menu-open">
                <router-link to="/up" class="nav-link active" style="background: white; color: black">
                   
            
                <a type="submit" data-toggle="modal" data-target="#editModal">
                    Se faire Consulter?
                  </a>
                </router-link>
        </li>
                            <li class="nav-item menu-open" >
                                <router-link to="/ordo" class="nav-link active" style="background: white; color: black" >
                                    <p>
                                        Mes Ordonnances
                            ...
                            <li class="nav-item menu-open">
                                <router-link to="#" class="nav-link active" style="background: white; color: black">
                                    <p>
                                        Mes Rendez-Vous
                                        <i class="right fas fa-angle-left"></i>
                                    </p>
                            ...
                            <li class="nav-item menu-open">
                                <router-link to="/derma" class="nav-link active" style="background: white; color: black">
