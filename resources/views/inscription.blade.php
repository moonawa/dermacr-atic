        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" action="{{ route('medecins.store') }}"  method="POST">
                {{ csrf_field() }}
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      <input type="text" class="form-control form-control-user" id="hopital" name="hopital" placeholder="hopital ou clinique">
                    </div>
                    <div class="col-sm-6">
